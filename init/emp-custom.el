(custom-set-variables
 ...
 '(company-backends '(company-tide company-inf-ruby))
 '(company-begin-commands '(self-insert-command))
 '(company-global-modes '(not not ruby-mode))
 ...
 '(global-eldoc-mode t)
 '(go-mode-hook '(my-go-mode-hook git-gutter-mode flycheck-mode))
 '(goflymake-debug t)
 ...
 '(recentf-arrange-rules '(("Go files (%d)" ".\\.go'")))
 ...
 '(tide-allow-popup-select '(code-fix jump-to-implementation))
